...
const FieldQuiz = ({ onFieldSelect, selectedField, user, onSaveToProfile, isOpen, onClose, onOpenAccount }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 z-50">
      <div 
        className="bg-white rounded-2xl max-w-2xl w-full max-h-[85vh] sm:max-h-[90vh] overflow-hidden shadow-2xl flex flex-col"
        ...
        <div className="flex-1 overflow-y-auto px-6 sm:px-8 py-6">
            ...
            <div className="border-t border-gray-100 pt-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                {user ? (
                  ...
                  <div className="flex-1 flex items-center justify-center px-5 py-3 bg-amber-50 text-amber-700 rounded-xl font-medium text-sm border border-amber-200">
                ...
                <button
                  ...
                  className="flex items-center justify-center px-5 py-3 border border-gray-300 text-gray-700 rounded-xl font-medium hover:bg-gray-50 transition-colors"
                >
                  ← Try Another
                </button>
              </div>
          ...
          {!showRecommendations && (
            <div className="text-center py-6 px-4 bg-gray-50 rounded-xl border border-dashed border-gray-200">
              ...
              <h4 className="font-semibold text-gray-900 mb-1">Ready to Discover?</h4>
